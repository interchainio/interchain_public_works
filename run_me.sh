### Item Add: EPIC: Dev UX (https://github.com/cosmos/cosmos-sdk/issues/13085)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/13085 --owner interchainio
...
### Item Add: EPIC: Separate all SDK modules into standalone go modules (https://github.com/cosmos/cosmos-sdk/issues/11899)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/11899 --owner interchainio
...
### Item Add: EPIC: Separate x/auth and vesting (https://github.com/cosmos/cosmos-sdk/issues/9958)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/9958 --owner interchainio
...
### Item Add: EPIC: determinism with maps (https://github.com/cosmos/cosmos-sdk/issues/13039)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/13039 --owner interchainio
...
### Item Add: [Epic]: Runtime (https://github.com/cosmos/cosmos-sdk/issues/17045)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/17045 --owner interchainio
...
### Item Add: Additional features for gov module (https://github.com/cosmos/cosmos-sdk/issues/17781)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/17781 --owner interchainio
...
### Item Add: Epic: x/accounts (https://github.com/cosmos/cosmos-sdk/issues/17786)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/17786 --owner interchainio
...
### Item Add: Split Cons pubkey rotation PR (https://github.com/cosmos/cosmos-sdk/issues/18141)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/18141 --owner interchainio
...
### Item Add: Implement PebbleDB Pruning and Fixes (https://github.com/cosmos/cosmos-sdk/issues/18462)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/18462 --owner interchainio
...
### Item Add: [Feature]: protocol funds (https://github.com/cosmos/cosmos-sdk/issues/18374)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/18374 --owner interchainio
...
### Item Add: [Epic]: Phase 2 Documentation (https://github.com/cosmos/cosmos-sdk-docs/issues/84)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk-docs/issues/84 --owner interchainio
...
### Item Add: [Epic]: auth/tx migration (https://github.com/cosmos/cosmos-sdk/issues/18446)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/18446 --owner interchainio
...
### Item Add: [Epic]: Storage/v2 (https://github.com/cosmos/cosmos-sdk/issues/17041)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/17041 --owner interchainio
...
### Item Add: [Epic]: Rolling Upgrades (https://github.com/cosmos/cosmos-sdk/issues/18523)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/18523 --owner interchainio
...
### Item Add: [Epic]: Client v2 (https://github.com/cosmos/cosmos-sdk/issues/18580)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/18580 --owner interchainio
...
### Item Add: [EPIC]: Sign modes reduction (https://github.com/cosmos/cosmos-sdk/issues/18591)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/18591 --owner interchainio
...
### Item Add: [Epic]: Bank/v2 (https://github.com/cosmos/cosmos-sdk/issues/17579)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/17579 --owner interchainio
...
### Item Add: [Epic]: Proving Execution (https://github.com/cosmos/cosmos-sdk/issues/19906)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/19906 --owner interchainio
...
### Item Add: [Epic]: x/Auth (https://github.com/cosmos/cosmos-sdk/issues/20058)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/20058 --owner interchainio
...
### Item Add: [Epic]: Cosmovisor 1.6.0 (https://github.com/cosmos/cosmos-sdk/issues/20067)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/20067 --owner interchainio
...
### Item Add: [Feature/baseapp]: integrate comet v1  (https://github.com/cosmos/cosmos-sdk/issues/20267)
gh project item-add 3 --url https://github.com/cosmos/cosmos-sdk/issues/20267 --owner interchainio
